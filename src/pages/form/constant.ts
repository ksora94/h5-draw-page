export const Privacy = '欢迎您进入本广告推广页面，我们非常重视您的隐私保护和个人信息保护，请您在使用我们的服务前，仔细阅读并了解本《个人信息授权与保护声明》（以下简称为“本声明”）。对于与您的权益存在重大关系的条款，请您注意仔细阅读。我们在您进入页面时提醒您充分阅读本《个人信息授权与保护声明》，并选择接受或不接受。特别需要您注意，您一旦主动在页面填写您的个人信息并进行提交操作，即意味着您同意我们按照本声明收集、使用、共享您的相关信息。若您不接受本声明，请勿登记您的个人信息。\n' +
    '\n' +
    ...
    '八、如何联系我们\n' +
    '\n' +
    '客服电话：4006305186，如果您对本声明有任何疑问、意见或建议，包括您需要对您提交的个人信息进行更正、修改和删除，或是您需要就相关事项进行投诉，可以通过以上方式与我们联系，我们将会在7个工作日内尽快予以联系或回复。\n' +
    '\n' +
    '九、适用法律\n' +
    '\n' +
    '1.本声明适用中华人民共和国法律。\n' +
